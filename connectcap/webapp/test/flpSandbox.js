		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "myapp",
									"targetURL": "#nsconnectcap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsconnectcap-display": {
								"semanticObject": "nsconnectcap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.connectcap",
									"url": sap.ui.require.toUrl("ns/connectcap")
								}
							}
						}
					}
